...
if REQUEST.cookies.get('came_from'):
    # if we used the cookie or not, we need to expire it
    portal = context.portal_url.getPortalObject()
    REQUEST.RESPONSE.expireCookie('came_from', path=portal.absolute_url_path())
